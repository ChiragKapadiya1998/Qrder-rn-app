...
import {
  addMenuMastersAction,
  editMenuMastersAction,
...
const EditItemMasters = () => {
  ...
  const [unitName, setUnitName] = useState(data?.unit);
  const [materialName, setMaterialName] = useState(data?.material_name);
  const [inWeightNmae, setInWeightNmae] = useState(data?.stock);
  ...
  const onPressEdit = async () => {
    if (materialName == '') {
      ...
      dispatch(editMenuMastersAction(obj));
    }
  };
